...
this.top&&null==this.left&&null==this.right&&null==this.bottom}};b.css(this.options.css);this.showModalBlanket();this.keyup=_.bind(this.keyup,this);this.click=_.bind(this.click,this);$(document.body).keyup(this.keyup);$(document.body).click(this.click);!0===this.options.bodyOverflowHidden&&(this.originalBodyOverflowValue=$(document.body).css("overflow"),$(document.body).css("overflow","hidden"));a.append(b);a.css({opacity:0,position:"absolute","z-index":999999});c.isEmpty()?(d-=b.outerHeight()/2,
"undefined"!==typeof this.options.y&&(d=this.options.y),a.css({top:d+"px"}),b=e-b.outerWidth()/2,"undefined"!==typeof this.options.x&&(b=this.options.x),a.css({left:b+"px"})):(null!=c.top&&a.css({top:c.top}),null!=c.left&&a.css({left:c.left}),null!=c.right&&a.css({right:c.right}),null!=c.bottom&&a.css({bottom:c.bottom}));this.options.setFocusOnFirstFormControl&&this.setFocusOnFirstFormControl();if(this.options.showCloseButton){var f=this;$("<a href='#' id='modalCloseButton'>&#160;</a>").css({}).appendTo(this.modalContainer).click(function(a){a.preventDefault();
